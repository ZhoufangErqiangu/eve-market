...
export class AllianceApi extends runtime.BaseAPI {
    ...
    /**
     * Get the icon urls for a alliance  --- Alternate route: `/legacy/alliances/{alliance_id}/icons/`  Alternate route: `/v1/alliances/{alliance_id}/icons/`  --- This route expires daily at 11:05  --- [Diff of the upcoming changes](https://ali-esi.evepc.163.com/diff/latest/dev/#GET-/alliances/{alliance_id}/icons/)
     * Get alliance icon
     */
